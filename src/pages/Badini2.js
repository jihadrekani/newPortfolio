...
import birkari from '../images/SeretayiBadini/pola2/birkari.jpg'
import kurdi from '../images/SeretayiBadini/pola2/kurdi.jpg'
import ezdiyati from '../images/SeretayiBadini/pola2/ezdiyati.jpg'
  ...
  return (
    <div className="">
      <h2 className="text-center font-bold text-3xl mt-[50px] mb-5 text-sky-900">
       222222پەرتوکێن پوڵا ئێکێ سەرەتایی
      </h2>
          ...
          <div className="flex justify-center ">
            <div className="rounded-lg shadow-lg max-w-sm bg-gray-900">
              ...
              <div className="p-6 flex items-center justify-center">
                <a href="https://www.bgprogram.org/download.aspx?id=1212" 
        ...
        <div className="rounded ">
          <div className="flex justify-center ">
            <div className="rounded-lg shadow-lg max-w-sm bg-gray-900">
                ...
                />
              <div className="p-6 flex items-center justify-center">
                <a href="https://www.bgprogram.org/download.aspx?id=997" 
        ...
        <div className="rounded ">
          <div className="flex justify-center ">
            <div className="rounded-lg shadow-lg max-w-sm bg-gray-900">
                ...
                />
              <div className="p-6 flex items-center justify-center">
                <a href="https://www.bgprogram.org/download.aspx?id=995" 
...
<div className="rounded ">
          <div className="flex justify-center ">
            <div className="rounded-lg shadow-lg max-w-sm bg-gray-900">
                ...
                />
              <div className="p-6 flex items-center justify-center">
                <a href="https://www.bgprogram.org/download.aspx?id=1211" 
...
<div className="rounded ">
          <div className="flex justify-center ">
            <div className="rounded-lg shadow-lg max-w-sm bg-gray-900">
                ...
                />
              <div className="p-6 flex items-center justify-center">
                <a href="https://www.bgprogram.org/download.aspx?id=1209" 
...
<div className="rounded ">
          <div className="flex justify-center ">
            <div className="rounded-lg shadow-lg max-w-sm bg-gray-900">
                ...
                />
              <div className="p-6 flex items-center justify-center">
                <a href="https://www.bgprogram.org/download.aspx?id=1210" 
